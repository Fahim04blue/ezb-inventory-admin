...
export function DashboardPageHeader({ onRefresh, isRefreshing }: { onRefresh: () => void; isRefreshing: boolean }) {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
      ...
      <Button variant="outline" onClick={onRefresh} disabled={isRefreshing} className="h-9 w-fit rounded-lg border-slate-200 bg-white px-3 shadow-sm">
